...
const CRABADA_ATTACKER_PK = process.env['CRABADA_ATTACKER_PK'] ? process.env['CRABADA_ATTACKER_PK'] : MAINNET_AVAX_MAIN_ACCOUNT_PK
...
export default {
  ...
  networks: {
    ...
    local: {
      ...
      chainId: 43112,
      accounts: USE_MAINNET_ACCOUNT ? [ MAINNET_AVAX_MAIN_ACCOUNT_PK, CRABADA_ATTACKER_PK ] : [
