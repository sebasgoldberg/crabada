...
export const CONFIG_BY_NODE_ID: ConfigByNodeId = {
    1: { accountsConfigs: [looter2, looter1, main] },
    2: { accountsConfigs: [main, looter2, looter1 ] },
    4: { accountsConfigs: [looter2, looter1, main]},
    5: { accountsConfigs: [main, looter2, looter1 ] },
    9: { accountsConfigs: [main, looter2, looter1 ] },
    11: { accountsConfigs: [looter2, looter1, main]},
}