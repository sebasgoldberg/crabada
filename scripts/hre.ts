...
export class CrabadaNetwork{
    ...
    getIdleGameApiDomain(): string{
        if (this.isSwimmerTestNetwork()){
            return 'idle-game-subnet-test-api.crabada.com'
        }else{
            return 'idle-api.crabada.com'
        }
    }

    getIdleGameApiBaseUrl(): string{
        return `https://${ this.getIdleGameApiDomain() }`
    }

    getCrabadaApiDomain(): string{
        if (this.isSwimmerTestNetwork()){
            return 'subnet-test-api.crabada.com'
        }else{
            return 'api.crabada.com'
        }
    }

    getCrabadaApiBaseUrl(): string{
        return `https://${ this.getCrabadaApiDomain() }`
    }
