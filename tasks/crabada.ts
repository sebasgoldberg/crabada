...
import { AccountConfig, CONFIG_BY_NODE_ID, looter1, looter2, main, NodeConfig, player1, player2, player3, player4, player5,  } from "../config/nodes";
...
const listenPendingStartGameTransaction = async (hre: HardhatRuntimeEnvironment, pendingTransactionsTask: PendingTransactionsTask, interval: number = 500): Promise<NodeJS.Timer> => {
...
const SETTLER_TARGET_BALANCE = parseEther('4')
